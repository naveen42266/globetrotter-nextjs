...
const ShareButton = ({ gameId, username, score }: ShareButtonProps) => {
          ...
          <div className="bg-white rounded-lg p-6 max-w-md w-full">
            ...
            <div className="mb-4">
              ...
              <input
                type="text"
                readOnly
                value={`${window.location.origin}/${username}/${gameId}`}
            ...
            <div className="flex space-x-3">
              <a
                href={`https://wa.me/?text=I scored ${score.correct} in Globetrotter Challenge! Can you beat my score? ${window.location.origin}/${username}/${gameId}`}
                target="_blank"
